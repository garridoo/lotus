...
### mutant - root v. rhizosphere v. soil
...
### get mean R.A. in mutant rhizosphere samples
...
ggsave(paste(figures.dir, "manhattan_mutant_root.pdf", sep=""), p1, width=10, height=3, useDingbats=F)
...
ggsave(paste(figures.dir, "manhattan_mutant_rhizo.pdf", sep=""), p1, width=10, height=3, useDingbats=F)
