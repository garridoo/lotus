...
### nfr5_2 mutant: root/rhizosphere/soil enriched OTUs

# subset samples

idx <- design$compartment %in% c("root", "soil", "rhizosphere") & 
       design$genotype %in% c("nfr5_2", "soil") &
       design$soil=="CAS8" &
       design$run!="1416"
...
pdf(file=paste(figures.dir, "nfr5_2_root_rhizo_soil_enrichment_cas8.pdf", sep=""))

tern_e(df, prop_size=T, col=colors, grid_color="grey",
       labels_color="transparent", pch=19, main="nfr5-2")
